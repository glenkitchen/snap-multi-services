    ...
    <section id="equipment" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Equipment Categories</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Quality equipment for every need. Discover our range of air-related equipment, compressors, and generators.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <EquipmentCard
            ...
            imageSrc="https://images.unsplash.com/photo-1609346046041-3d9b93c70a80?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
